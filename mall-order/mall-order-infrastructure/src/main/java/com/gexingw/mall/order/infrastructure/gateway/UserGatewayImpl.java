package com.gexingw.mall.order.infrastructure.gateway;

import com.gexingw.mall.domain.user.UserGateway;
import com.gexingw.mall.domain.user.model.User;
import com.gexingw.mall.order.infrastructure.convert.user.UserConvert;
import com.gexingw.mall.order.infrastructure.gateway.order.rpc.UserRpcMapper;
